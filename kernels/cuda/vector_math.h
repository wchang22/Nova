...
inline __host__ __device__ float distance(float2 u, float2 v) { return length(u - v); }
inline __host__ __device__ float distance(float3 u, float3 v) { return length(u - v); }
inline __host__ __device__ float distance(float4 u, float4 v) { return length(u - v); }
