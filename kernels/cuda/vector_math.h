...
inline __device__ uchar4 make_uchar4(float4 a) { return make_uchar4(a.x, a.y, a.z, a.w); }
inline __device__ uchar4 make_uchar4(uint4 a) { return make_uchar4(a.x, a.y, a.z, a.w); }
inline __device__ uchar4 make_uchar4(uchar3 a, int b) {
  return make_uchar4(a.x, a.y, a.z, b);
}
inline __device__ uchar3 make_uchar3(float3 a) { return make_uchar3(a.x, a.y, a.z); }
inline __device__ uchar3 make_uchar3(uchar4 a) { return make_uchar3(a.x, a.y, a.z); }
...
inline __device__ float3 make_float3(float a, float2 b) {
...
inline __device__ float3 make_float3(uchar3 a) {
  return make_float3(float(a.x), float(a.y), float(a.z));
}
...
inline __device__ uint3 make_uint3(uchar3 a) {
  return make_uint3(uint(a.x), uint(a.y), uint(a.z));
}
...
inline __device__ uint4 make_uint4(uchar4 a) {
  return make_uint4(uint(a.x), uint(a.y), uint(a.z), uint(a.w));
}
...
inline __device__ float distance(float2 u, float2 v) { return length(u - v); }
inline __device__ float distance(float3 u, float3 v) { return length(u - v); }
inline __device__ float distance(float4 u, float4 v) { return length(u - v); }
...
inline __device__ float3 mix(float3 a, float3 b, float w) { return (1.0f - w) * a + w * b; }

////////////////////////////////////////////////////////////////////////////////
// pw
////////////////////////////////////////////////////////////////////////////////

inline __device__ float3 pow(float3 a, float3 b) {
  return make_float3(pow(a.x, b.x), pow(a.y, b.y), pow(a.z, b.z));
}

inline __device__ float3 pow(float3 a, float b) {
...
inline __device__ uchar3 isless(float3 a, float b) {
  return make_uchar3(a.x < b, a.y < b, a.z < b);
}
inline __device__ uchar3 isgreaterequal(float3 a, float b) {
  return make_uchar3(a.x >= b, a.y >= b, a.z >= b);
}

inline __device__ bool any(uchar3 a) { return a.x || a.y || a.z; }
inline __device__ bool all(uchar3 a) { return a.x && a.y && a.z; }
