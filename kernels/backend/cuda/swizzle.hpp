...
#define TRANSFORM2(x, y) u.x, u.y
#define TRANSFORM3(x, y, z) u.x, u.y, u.z
#define TRANSFORM4(x, y, z, w) u.x, u.y, u.z, u.w

#define GET_MACRO(_1, _2, _3, _4, NAME, ...) NAME

#define CONCAT(...) GET_MACRO(__VA_ARGS__, CONCAT4, CONCAT3, CONCAT2)(__VA_ARGS__)
#define TRANSFORM(...) GET_MACRO(__VA_ARGS__, TRANSFORM4, TRANSFORM3, TRANSFORM2)(__VA_ARGS__)

#define ADD_SWIZZLE(...)                               \
  template <typename W, typename U>                    \
  __device__ constexpr W CONCAT(__VA_ARGS__)(U && u) { \
    return { TRANSFORM(__VA_ARGS__) };                 \
  }
